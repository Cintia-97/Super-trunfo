...
var cartaEmma = {
    nome: "Emma",
    imagem:"https://i.pinimg.com/736x/ed/63/26/ed6326aa5861dfa34144917bd883e1c2.jpg",
    atributos: {
        ataque: 80,
        defesa: 100,
        magia: 0,
...
var cartaOnePunchman = {
    nome: "One Punch man",
    imagem: "https://www.leak.pt/wp-content/uploads/2020/04/one-punch-man-2.jpg",
    atributos: {
        ataque: 100,
        defesa: 100,
        magia: 100
...
var cartas = [cartaPaulo, cartaRafa, cartaGui, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel, cartaEmma, cartaOnePunchman]
//            0           1           2          3         4            5            6           7     
...
function jogar() {
    ...
    if (cartas.length == 0 ){
      ...
      if (pontosJogador > pontosMaquina) {
        htmlResultado = '<p class="resultado-final">Jogador ganhou</p>' 
      } else if (pontosMaquina > pontosJogador){
        htmlResultadoo = '<p class="resultado-final">Jogador Perdeu</p>' 
      }
    } else {
...
function proximaRodada() {
  ...
  //O metodo splice precisa de 2 parametros para funcionar, um é que valor ele vai tirar e o outro é a quantidade que será retirada, caso o 1 fosse substituído pelo 2, seria tirado o item e o seguinte dele, é um padrão do JS.